...
<li class='nav-item'><a class='nav-link' href='javascript:alert("Not implemented")'><i class='nav-icon la la-stream'></i> Категории</a></li>
<li class='nav-item'><a class='nav-link' href='javascript:alert("Not implemented")'><i class='nav-icon la la-cookie'></i> Каталог</a></li>
